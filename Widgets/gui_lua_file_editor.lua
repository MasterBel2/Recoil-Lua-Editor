...
local requiredFrameworkVersion = 39
local key
...
local tokenTypeColors = {
    [TOKEN_TYPE_STRING_LITERAL] = "\255\255\001\001",
    [TOKEN_TYPE_MULTILINE_STRING_LITERAL] = "\255\255\001\001",
    [TOKEN_TYPE_COMMENT] = "\255\100\100\100",
    [TOKEN_TYPE_MULTILINE_COMMENT] = "\255\100\100\100",
    [TOKEN_TYPE_NUMBER_LITERAL] = "\255\001\001\255",
    [TOKEN_TYPE_KEYWORD] = "\255\255\001\255",
    [TOKEN_TYPE_ATTRIBUTE] = "\255\255\100\001",
}
